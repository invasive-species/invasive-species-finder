...
class SignInView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SignInScreen(
      ...
      headerBuilder: headerImage('assets/images/invasive.png'),
      sideBuilder: sideImage('assets/images/invasive.png'),
      subtitleBuilder: (context, action) {
        return Padding(
          padding: const EdgeInsets.only(bottom: 8),
          child: Text(
            action == AuthAction.signIn
                ? 'Welcome to Invasive Species Finder! Please sign in.'
                : 'Welcome to Invasive Species Finder! Please create an account.',
          ),
        );
      },
