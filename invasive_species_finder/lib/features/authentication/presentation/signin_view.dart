...
import 'package:invasive_species_finder/features/user/domain/user_db.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: <Widget>[
            ...
            Column(
              children: <Widget>[
                Image.asset('assets/images/invasive.png', width: 300),
                    ...
                    if(validEmailAndPassword) {
                      ...
                      if (userDB.isUserEmail(email)) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Unknown email address, try one of:  ${userDB.getAllEmails().join(', ')}'),
